...
--------             ------       -----------  --------     ------
array_test1          231          44           50.00%       PASS
multiarray           1770         261          68.97%       PASS
...
```
...
| 测试用例 | Cycles | 预测数 | 准确率 |
|---------|--------|--------|--------|
| array_test1 | 231 | 44 | 50.00% |
| array_test2 | 259 | 50 | 54.00% |
| basicopt1 | 654,991 | 190,750 | 66.00% |
| bulgarian | 406,781 | 91,458 | 82.71% |
| expr | 580 | 123 | 80.49% |
| gcd | 639 | 171 | 57.89% |
| hanoi | 195,117 | 28,207 | 65.47% |
| lvalue2 | 64 | 14 | 42.86% |
| magic | 652,260 | 89,279 | 71.03% |
| manyarguments | 82 | 18 | 33.33% |
| multiarray | 1,770 | 261 | 68.97% |
| naive | 33 | 4 | 50.00% |
| pi | 123,930,153 | 42,208,788 | 76.84% |
| qsort | 1,515,010 | 268,671 | 77.93% |
| queens | 682,003 | 99,701 | 60.43% |
| statement_test | 1,324 | 280 | 52.14% |
| superloop | 588,825 | 445,087 | 91.36% |
| tak | 2,037,302 | 197,071 | 63.08% |